            ...
            <div className="displaygrid_1 bg_white rounded-4 shadow-sm px-4 py-5 mb-3 h-auto w-full">
                <div className="flex gap-2 justify-start w-full">
                    ...
                    <div className="flex flex-col w-full">
                        <span className="plusJakara_medium text_secondary">Route Created</span>
                ...
                <div className="flex gap-2 justify-start w-full">
                    ...
                    <div className="flex flex-col w-full">
                        <span className="plusJakara_medium text_secondary">Route Completed</span>
                        {/* {!categories?.totalCourses ?
                            <div className="flex items-center ms-5">
                                <CircularProgress size={18} className='text_dark' />
                            </div> : */}
                ...
                <div className="flex gap-2 justify-start w-full">
                    ...
                    <div className="flex flex-col w-full">
                        <span className="plusJakara_medium text_secondary">Incomplete Routes</span>
                        {/* {!categories?.totalCourses ?
                            <div className="flex items-center ms-5">
                                <CircularProgress size={18} className='text_dark' />
                            </div> : */}
                ...
                <div className="flex gap-2 justify-start w-full">
                    ...
                    <div className="flex flex-col w-full">
                        <span className="plusJakara_medium text_secondary">Avg Route Duration</span>
                        {/* {!categories?.totalCourses ?
                            <div className="flex items-center ms-5">
                                <CircularProgress size={18} className='text_dark' />
                            </div> : */}
