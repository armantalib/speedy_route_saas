...
const RouteForm = () => {
  ...
  const handleSelect = (_, option, type) => {
    ...
    if (type === "start") setStart({ coordinates, place_name });
      ...
      setStops([...stops, { coordinates, place_name }]);
      setNotes((prev) => ({ ...prev, stops: [...prev.stops, ""] }));
    } else if (type === "destination") setDestination({ coordinates, place_name });
  ...
  const handleOptimize = async () => {
    ...
    try {
      ...
      await setDuration(optimizeResponse.data.duration / 3600)
      await setDistance(optimizeResponse.data.distance / 1609.34)
    } catch (error) {
      ...
      {!showMap ? (
        ...
        <div className="route-form-container">
          <div className="route-header">
            ...
            <Title level={3}>New Driver</Title>
            <Paragraph>
              ...
              <Form layout="vertical">
                ...
                <div className="stop-block">
                  ...
                  <Button
                    ...
                    icon={<PlusOutlined />}
                    onClick={() => {
                      setStops([...stops, { place_name: "", clientName: "", coordinates: null }]);
                      setNotes((prev) => ({ ...prev, stops: [...prev.stops, ""] }));
                    }}
                  >
                    Add Stops
