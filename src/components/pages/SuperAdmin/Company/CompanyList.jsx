...
const CompanyList = (props) => {
    ...
    dispatch(setHeaderName('Companies'))
            ...
            cell: (row) => {
                return (
                    <div onClick={() => {
                        ...
                        <p style={{ marginLeft: 10, fontWeight: 'bold', fontSize: 14 }}>{row?.company_name}</p>
                    </div>
                )
            }
        },
            ...
            cell: (row) => {
                return (
                    <div onClick={() => {
                        ...
                        <p style={{ fontWeight: 'bold', fontSize: 14, textTransform: 'capitalize' }}>{row?.plan}</p>
                    </div>
                )
            }
        },
            ...
            cell: (row) => {
                return (
                    <div onClick={() => {
                        ...
                        <p style={{ fontWeight: 'bold', fontSize: 14, textTransform: 'capitalize' }}>{'0'}</p>
                    </div>
                )
            }
        },
            ...
            cell: (row) => {
                return (
                    <div onClick={() => {
                        ...
                        <p style={{ fontWeight: 'bold', fontSize: 14, textTransform: 'capitalize' }}>{'150/month'}</p>
                    </div>
                )
            }
        },
    ...
    const fetchData = async () => {
        ...
        try {
            let allData = [];
            let data1 = {}
            const endPoint = `company/s-admin/${currentPage}?category=${selectedCategory}&search=${search}`;
