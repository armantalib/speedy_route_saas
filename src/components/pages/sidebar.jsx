...
const SidebarMenu = ({ children, setToggled, toggled, setBroken }) => {
    ...
    const menuItems = [
        ...
        {
            items: "Team",
            image: user_icons, image2: user_icons,
            subItems: [
        ...
        { image: prof_delivery_icon, image2: prof_delivery_icon, items: "Proof Of Delivery", path: '/prof/list' },
                                            ...
                                            <Fragment key={i}>
                                                {item.subItems ? (
                                                    <SubMenu icon={<img
                                                        ...
                                                        src={isChildPath(item.path, location.pathname) ? item.image2 : item.image}
                                                        alt=""
                                                    />} label={item.items} className={`w-full plusJakara_semibold text_secondary rounded-3 mb-2`}>
