    ...
    const fetchData = async () => {
        ...
        try {
            ...
            for (let page = 1; page <= totalPages; page++) {
                let data1 = {}
                const endPoint = `resources/admin/get/${page}/safety`
        ...
        <StyleSheetManager shouldForwardProp={(prop) => !['sortActive'].includes(prop)}>
            ...
            <div className="flex justify-between gap-3 items-center w-full">
                <div className="flex flex-col mb-5 w-full">
                    <h2 className='plusJakara_bold text_black'>Safety Resources</h2>
                    <h6 className="text_secondary plusJakara_regular">Information about your current plan and usages</h6>
                </div>
                <button onClick={() => { navigate('/safety/add-safety') }} style={{ width: '150px' }} className="bg_primary py-3 rounded-3 text_white plusKajara_semibold">Add Safety</button>
            </div>
