...
import { Table, Tag, Avatar, Button, Input, Tabs, Typography } from "antd";
import DriverDetailsModal from './DriverDetailsModal';
import { useDispatch } from 'react-redux';
import { setHeaderName } from '../../../storeTolkit/userSlice';
import EditDataModal from './EditDataModal';
import ProfileComp from './ProfileComp';
const CompanySettingsList = (props) => {
    ...
    dispatch(setHeaderName('Settings'))
   ...
   const [input, setInput] = useState({
        ...
        return (
            <StyleSheetManager shouldForwardProp={(prop) => !['sortActive'].includes(prop)}>
                <main className="min-h-screen lg:container py-1 px-4 mx-auto">
                    ...
                    <Typography.Text level={4} className="form-title">
    ...
    const items = [
        { key: "1", label: "Profile", children: <ProfileComp /> },
        { key: "2", label: "Password", children: <AddDriverModal /> },
        // { key: "3", label: "Team", children: <SettingsTeamForm /> },
        { key: "3", label: "Plan", children: <AddDriverModal /> },
        { key: "4", label: "Addons", children: <AddDriverModal /> },
        //   { key: "6", label: "Billing" },
    ];