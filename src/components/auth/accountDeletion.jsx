                ...
                <div className='w-full lg:w-1/2 h-full overflow-y-scroll p-4'>
                    <div className='flex flex-col h-[90vh] md:h-[100%]'>
                        ...
                        <div className='border border-white p-xl-4'>
                            <h2 className='poppins_semibold text-xl mb-0 md:mb-auto md:text-2xl lg:text-3xl text_black'>Delete Account</h2>
                            <p className='text_secondary max-md:text-sm poppins_regular my-2'>Enter information to delete the account request</p>
                            <Form layout='verticle' className='flex flex-wrap justify-between' onFinish={handleSubmit}>
                                ...
                                <div className='w-full my-3'>
                                    {!isProcessing ? (
                                        <button type='submit' className='w-full rounded-3 bg_darkprimary text_white p-2 text-lg plusJakara_regular flex justify-center items-center'>Delete</button>
                                    ) : (
...
export default AccountDeletetion;